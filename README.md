<head><style>body{ background-image:url('(https://img.freepik.com/free-vector/abstract-white-gold-background_23-2149290000.jpg?w=2000)'); background-repeat:repeat; }</style></head>
